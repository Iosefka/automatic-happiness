{} /* Background */
.app {
    background-image: url("http://i.imgur.com/stLz3eK.jpg");
    background-size: cover !important;
    background-position: center;
}
.callout-backdrop {
    opacity:1 !important;
    background: url("https://images4.alphacoders.com/706/706365.png");
...
.member-roles .member-role .member-role-remove {
    background: url(http://i.imgur.com/aACperk.png) 50% no-repeat;
    width: 8px;
    height: 12px;
    background-size: 8px;
}
